...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.widget_2.setGeometry(QtCore.QRect(0, 0, 801, 61))
        self.widget_2.setStyleSheet("background-color: rgb(77, 77, 77);")
        self.widget_2.setObjectName("widget_2")
        self.label = QtWidgets.QLabel(self.widget_2)
        self.label.setGeometry(QtCore.QRect(10, 20, 281, 25))
        font = QtGui.QFont()
        ...
        self.widget_3.setGeometry(QtCore.QRect(120, 60, 681, 541))
        ...
        self.widget_5.setGeometry(QtCore.QRect(120, 60, 671, 551))
        ...
        self.widget_4.setGeometry(QtCore.QRect(0, 0, 801, 611))
        self.widget_4.setStyleSheet("background-color: rgb(109, 109, 109);")
        ...
        self.lineEdit_6.setStyleSheet("color: rgb(99, 78, 255);\n"
        ...
        self.lineEdit_4.setGeometry(QtCore.QRect(160, 70, 161, 31))
        self.lineEdit_4.setObjectName("lineEdit_4")
        self.lineEdit_7 = QtWidgets.QLineEdit(self.widget_6)
        self.lineEdit_7.setGeometry(QtCore.QRect(160, 110, 161, 31))
        self.lineEdit_7.setObjectName("lineEdit_7")
        self.dateEdit = QtWidgets.QDateEdit(self.widget_6)
        self.dateEdit.setGeometry(QtCore.QRect(160, 150, 161, 31))
        self.dateEdit.setObjectName("dateEdit")
        self.pushButton_13 = QtWidgets.QPushButton(self.widget_6)
        self.pushButton_13.setGeometry(QtCore.QRect(340, 200, 151, 35))
        ...
        self.label_13.setGeometry(QtCore.QRect(50, 120, 101, 21))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(16)
        ...
        self.widget_7.setGeometry(QtCore.QRect(120, 60, 681, 551))
...
##################################################
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_6.setText(_translate("MainWindow", "Клиент успешно добавлен"))
    ...
    def autorization(self):
        ...
        try:
            ...
            conn = psycopg2.connect(
                host = 'localhost',
                database = 'postgres',
                user = 'postgres', #toddo self.lineEdit_5.text(),
                password = 'myhicursed', #toddo self.lineEdit_6.text(),
                port = '5432'
            )
            flag = True
        except:
